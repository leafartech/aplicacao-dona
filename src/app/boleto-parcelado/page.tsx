...
const getTimeUntilTarget = (): { days: number; hours: number; minutes: number; seconds: number } => {
    ...
    if (diff <= 0) {
        return { days: 0, hours: 0, minutes: 0, seconds: 0 }; // 🔹 Força o contador a zero se a data já passou
    }
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            if (
                ...
                window.location.href = 'https://pay.principia.net/checkout/aprimore-sisedu-?campaign=l1-isa-comercial'; // https://bit.ly/pos-listavip-18x
            }
        }, 1000);
