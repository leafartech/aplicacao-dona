                ...
                <Section className="sm:py-24 pt-24 pb-16 px-4">
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col text-center ">
                            <h2 className="text-black text-4xl font-bold">Obrigada pelas suas informações</h2>
                            <p className="text-black text-xl max-w-2xl">Agora, preste muita atenção nos passos abaixo:</p>
                        </div>
                        <div className="sm:max-w-2xl px-4">
                            <ul className="flex flex-col gap-6 sm:py-12 py-8 sm:px-8 px-6 border border-zinc-600 rounded-xl">
                                <li className="flex flex-col gap-1 ">
                                    ...
                                    <p className="text-zinc-600">Caso você tenha o perfil de enfermeiras que estamos buscando, a nossa equipe vai conversar com você para agendar o melhor horário para a sua Sessão de Direcionamento de Atuação.</p>
                                </li>
                                <li className="flex flex-col gap-1 ">
                                    <h5 className="text-xl font-semibold">2. Confira a sua caixa de entrada do e-mail:</h5>
                                    <p className="text-zinc-600">O login do Guia: Intercorrência Segura foi enviado e você já pode acessar a nossa Plataforma de Estudos. Caso você tenha alguma dúvida, pode entrar em contato através do contato@aprimoresisedu.com.</p>
                                </li>
                                {/* <li className="flex flex-col gap-1 ">
                ...
                <Section className="py-12 sm:py-24 px-4" classNameS="bg-zinc-800">
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            <h2 className="font-bold text-xl sm:text-3xl text-center max-w-3xl text-white ">Veja só o que aconteceu com elas depois de receber nossos direcionamentos de atuação:</h2>
